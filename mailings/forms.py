    ...
    class Meta:
        ...
        widgets = {
            "full_name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Иван Иванович Иванов"}
            ),
    ...
    def clean_email(self):
        ...
        if email:
            ...
            if existing_clients.exists():
                raise ValidationError("Клиент с таким email адресом уже существует.")
...
class MailingForm(forms.ModelForm):
    ...
    def clean_first_send_datetime(self):
        ...
        if first_send_datetime:
            ...
            if not self.instance.pk and first_send_datetime < timezone.now():
                raise ValidationError("Дата первой отправки не может быть в прошлом.")
    ...
    def clean(self):
        ...
        if not message:
            raise ValidationError("Необходимо выбрать сообщение для отправки.")
