...
urlpatterns = [
    ...
    path(
        "clients/<int:pk>/edit/", views.ClientUpdateView.as_view(), name="client_edit"
    ),
    path(
    ...
    path(
        "attempts/<int:pk>/",
        views.MailingAttemptDetailView.as_view(),
        name="attempt_detail",
    ),
    ...
    path(
        "manager/",
        manager_views.ManagerDashboardView.as_view(),
        name="manager_dashboard",
    ),
    path(
        "manager/mailings/",
        manager_views.ManagerMailingListView.as_view(),
        name="manager_mailing_list",
    ),
    path(
        "manager/users/",
        manager_views.ManagerUserListView.as_view(),
        name="manager_user_list",
    ),
    path(
        "manager/toggle-user/<int:user_id>/",
        manager_views.toggle_user_active,
        name="manager_toggle_user",
    ),
    path(
        "manager/toggle-mailing/<int:mailing_id>/",
        manager_views.toggle_mailing_status,
