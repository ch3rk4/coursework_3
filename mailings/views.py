...
from .cache import (CacheMixin, cache_global_stats, cache_mailing_stats,
                    cache_user_stats, invalidate_mailing_cache,
                    invalidate_user_cache)
from .decorators import (OwnerOrManagerRequiredMixin, OwnerRequiredMixin)
...
class MailingAttemptListView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        ...
        return (
            queryset.filter(mailing__owner=self.request.user)
